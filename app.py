...
def predict():
	...
	dictionary['sexo'] = request.form['sexo']
	dictionary['pais_residencia'] = request.form['pais_residencia']
	dictionary['age'] = request.form['age']
	dictionary['renta'] = request.form['renta']
	dictionary['segmento'] = request.form['segmento']
	dictionary['ind_actividad_cliente'] = request.form['ind_actividad_cliente']
	...
	final_preds = final_preds[0].replace(" ",", ")

	# return jsonify(recs=final_preds)
	return render_template('index.html', prediction_text='Recommended products are {}'.format(final_preds))
